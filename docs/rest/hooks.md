...
For more details please read [cloud code functions](cloudcode/index.md#cloud-functions).
...
For more details please read [cloud code triggers](cloudcode/index.md#beforesave-triggers).
