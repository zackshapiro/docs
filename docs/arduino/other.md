...
Head on over to the [REST API documentation](rest/index.md) to discover what's possible. For each code sample, you can switch it to Arduino to see what the function call would look like.
