...
## API
We support most of the sending options similar to the hosted Parse.com service. Check the detailed doc [here](rest/push-notifications.md#sending-options). Parse Server supports the following:
