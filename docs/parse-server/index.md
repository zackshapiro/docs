...
Now that you're running Parse Server, it is time to save your first object. We'll use the [REST API](rest/index.md), but you can easily do the same using any of the [Parse SDKs](/). Run the following:
