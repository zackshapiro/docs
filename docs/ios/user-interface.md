...
Developers interested in this kind of customization should take a look at the interface of [`PFLogInView`](https://github.com/parse-community/Parse-SDK-iOS-OSX/blob/master/ParseUI/Classes/LogInViewController/PFLogInView.h), where all customizable properties are documented.
...
Developer interested in this kind of customization should take a look at the interface of [`PFSignUpView`](https://github.com/parse-community/Parse-SDK-iOS-OSX/blob/master/ParseUI/Classes/SignUpViewController/PFSignUpView.h), where all customizable properties are documented.
...
A good starting point to learn more is to look at the [API for the class](https://github.com/parse-community/Parse-SDK-iOS-OSX/blob/master/ParseUI/Classes/QueryTableViewController/PFQueryTableViewController.h) and also the [template subclass file](https://gist.github.com/ba03c1a550f14f88f95d). We designed the class with customizability in mind, so it should accommodate many instances where you used to use `UITableViewController`.
