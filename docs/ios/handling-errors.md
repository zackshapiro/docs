...
For a list of all possible `NSError` types, scroll down to [Error Codes](errors), or see the `PFErrorCode` section of the [iOS-OSX API](https://parseplatform.org/Parse-SDK-iOS-OSX/api//Enums/PFErrorCode.html).
